      ...
      >
        {type === 'loading' && (
          <View className="items-center justify-center space-y-2">
            ...
            <Text className="text-primary-500 font-openSans text-[10px] uppercase font-bold tracking-wider">Loading...</Text>
          </View>
        )}
        {type === 'success' && (
          <View className="bg-emerald-500/10 border border-emerald-500/20 p-4 rounded-full">
            <Text className="text-emerald-500 font-bold" style={{ fontSize: size * 0.3 }}>✓</Text>
          </View>
        )}
        {type === 'construction' && (
        ...
        {type === 'empty' && (
          <View className="items-center justify-center p-3">
            ...
            <Text className="text-slate-400 font-openSans text-xs mt-1">No Data Available</Text>
          </View>
        )}
        {type === 'secure' && (
          <View className="bg-primary-500/10 border border-primary-500/20 p-4 rounded-full">
